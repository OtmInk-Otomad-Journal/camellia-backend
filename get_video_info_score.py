...
if(os.getenv("ONLINE_SCRAPE", "false").lower() == "true"):
    # 在线数据
    from get_video_info_score_online import all_video_info as online_video_info
    all_video_info.update(online_video_info)
else:
    from get_video_info_score_pull_data import all_video_info as pulled_video_info
    all_video_info.update(pulled_video_info)
